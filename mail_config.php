...
function sendOTP($email, $otp, $username = "User") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'sosuke.aizen.186cm@gmail.com';  // replace with your Gmail
        $mail->Password   = 'qvaiwvfhoyzrydrt';    // replace with your App Password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;

        $mail->setFrom('sosuke.aizen.186cm@gmail.com', 'Online Voting System');
